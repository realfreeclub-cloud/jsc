...
import paperSetsRoutes from './routes/paperSetsRoutes';
import enrollmentRoutes from './routes/enrollmentRoutes';
import testEnrollmentRoutes from './routes/testEnrollmentRoutes';
...
app.use('/api/v1/paper-sets', paperSetsRoutes);
app.use('/api/v1/enrollments', enrollmentRoutes);
app.use('/api/v1/test-enrollments', testEnrollmentRoutes);
